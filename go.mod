module github.com/0TrustCloud/secure_k8s
...
replace github.com/0TrustCloud/secure_network => ../secure_network

replace github.com/0TrustCloud/secure_policy => ../secure_policy

replace github.com/0TrustCloud/secure_ssh => ../secure_ssh
